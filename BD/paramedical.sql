...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 25 mai 2022 à 06:58
...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `Nom` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `commande` (`ID`, `Date`, `Statut`, `ID_Utilisateur`, `Nom`, `Rue`, `CodePostal`, `Ville`, `Mail`) VALUES
(1, '2022-05-23', 0, 2, 'Fouchard', 'Rue de la rue', 45000, 'Orléans', 'alexilian.fouchard@gmail.com');
...
CREATE TABLE IF NOT EXISTS `concerner` (
  ...
  KEY `FK_Contenance` (`ID_Contenance`),
...
INSERT INTO `concerner` (`ID`, `Quantite`, `ID_Produit`, `ID_Contenance`, `ID_Commande`) VALUES
(9, 4, 1, 1, 1),
(10, 1, 1, 2, 1),
(11, 2, 3, 3, 1);
...
CREATE TABLE IF NOT EXISTS `contenance` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Unite` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `note` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Note` int NOT NULL,
  `Avis` varchar(512) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `ID_Produit` int NOT NULL,
  `ID_Utilisateur` int NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `produit` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Nom` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Image` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Nom` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Prenom` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Telephone` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Code_Postal` varchar(5) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Ville` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Adresse` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
(1, 'Le Roy', 'Mathieu', '0000000000', '00000', 'Orléans', '10 Rue des Olives', 'mathieu@mail.com', '$2y$10$2xto2wg/SfxxdeJ2CewUNOQx.EYB5vJhSfChYeRNqNB5DdQCCZ4t6', 1),
...
ALTER TABLE `concerner`
  ...
  ADD CONSTRAINT `FK_Contenance` FOREIGN KEY (`ID_Contenance`) REFERENCES `contenance` (`ID`),
